...
public class WiredTriggerUserRoomVote extends InteractionWiredTrigger {
    public static final WiredTriggerType type = WiredTriggerType.USER_ROOMVOTE;

    private String username = "";

    public WiredTriggerUserRoomVote(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredTriggerUserRoomVote(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
