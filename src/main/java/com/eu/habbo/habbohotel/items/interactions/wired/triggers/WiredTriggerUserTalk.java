...
public class WiredTriggerUserTalk extends InteractionWiredTrigger {
    public static final WiredTriggerType type = WiredTriggerType.USER_TALK;

    private String username = "";

    public WiredTriggerUserTalk(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredTriggerUserTalk(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
