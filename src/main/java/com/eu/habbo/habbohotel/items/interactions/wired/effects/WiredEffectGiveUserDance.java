...
public class WiredEffectGiveUserDance extends InteractionWiredEffect {
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
        if (this.message.length() > 0 &&
            ...
            if (habbo != null) {
                ...
                if (dance.equals(Integer.valueOf(1))) {
                    dancetype = DanceType.HAB_HOP;
                } else if (dance.equals(Integer.valueOf(2))) {
                    dancetype = DanceType.POGO_MOGO;
                } else if (dance.equals(Integer.valueOf(3))) {
                    dancetype = DanceType.DUCK_FUNK;
                } else if (dance.equals(Integer.valueOf(4))) {
                    dancetype = DanceType.THE_ROLLIE;
                } else if (dance.equals(Integer.valueOf(0))) {
                    dancetype = DanceType.NONE;
                } else {
                    habbo.whisper("Digite um nde 0 a 4. (0 desativa)");
                }
