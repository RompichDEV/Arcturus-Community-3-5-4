...
public class WiredConditionNotMottoContains extends InteractionWiredCondition {
    public static final WiredConditionType type = WiredConditionType.ACTOR_WEARS_BADGE;

    private String motto = "";

    public WiredConditionNotMottoContains(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredConditionNotMottoContains(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
